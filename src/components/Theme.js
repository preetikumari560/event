...
const Theme = (props) => {
  ...
  return (
    <div>
      ...
      <div className={style+" w-2/3 h-72 md:w-11/12  m-auto  flex  flex-col justify-center relative left-4 md:left-0 mt-10 md:mt-0     shadow-lg border-2"}>
    
          <h3 className="self-center text-lg md:text-2xl">You are Invited ! 🎉</h3>
         </div>
         <div className="flex  w-fit mx-auto mt-12 shadow-xl justify-center relative left-4 md:left-0">
